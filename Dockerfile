...
# 4. Copia tutto il resto del codice del progetto nella cartella di lavoro
COPY . .

# 5. Esponi la porta su cui Gunicorn ascolterà
# Render si aspetta la porta 10000 per i servizi Docker
EXPOSE 10000

# 6. Definisci il comando per avviare l'applicazione
